                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="space-y-4 text-sm">
                                <div>
                                    ...
                                    <p class="font-medium text-base-content">{{ $submission->judul_publikasi ?? 'N/A' }}</p> {{-- Null safe operator --}}
                                </div>
                                <div>
                                    <label class="block text-xs font-semibold text-base-content/60 uppercase mb-1">Jenis</label>
                                    <p class="font-medium text-base-content">{{ $submission->type_publikasi ?? 'N/A' }}</p>
                                </div>
                                <div>
