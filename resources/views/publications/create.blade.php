{{-- 
    File ini adalah versi revisi total UI/UX halaman Tambah Publikasi.
                    ...
                    <form action="{{ route('publications.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div class="form-control w-full md:col-span-2">
                                ...
                                <input name="title_ind" type="text" value="{{ old('title_ind') }}" placeholder="Contoh: Statistik Indonesia 2025" class="input input-bordered w-full" required />
                            </div>

                            {{-- Judul Publikasi (ENG) --}}
                            <div class="form-control w-full md:col-span-2">
                                <label class="label"><span class="label-text font-semibold">Judul Publikasi (ENG)</span></label>
                                <input name="title_eng" type="text" value="{{ old('title_eng') }}" placeholder="Opsional" class="input input-bordered w-full" />
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <select name="publication_type" class="select select-bordered" required>
                                    <option disabled {{ old('publication_type') ? '' : 'selected' }}>Pilih Tipe</option>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input name="catalog_number" type="text" value="{{ old('catalog_number') }}" placeholder="Contoh: 1101001" class="input input-bordered w-full" required />
                            </div>

                            {{-- Tahun --}}
                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">Tahun</span></label>
                                <input name="year" type="number" value="{{ old('year') }}" placeholder="Contoh: 2025" class="input input-bordered w-full" required />
                            </div>

                            {{-- Frekuensi --}}
                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">Frekuensi</span></label>
                                <input name="frequency" type="text" value="{{ old('frequency') }}" placeholder="Contoh: Tahunan" class="input input-bordered w-full" required />
                            </div>

                            {{-- Nomor ISSN --}}
                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">No ISSN</span></label>
                                <input name="issn_number" type="text" value="{{ old('issn_number') }}" placeholder="Opsional" class="input input-bordered w-full" />
                            </div>
                        </div>
