{{-- 
    File ini adalah revisi total UI/UX halaman Edit Pegawai.
    Desainnya disamakan dengan halaman index dan create untuk menciptakan pengalaman yang konsisten,
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" name="name" class="input input-bordered w-full" required value="{{ old('name', $user->name) }}">
                            </div>

                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">NIP BPS</span></label>
                                <input type="text" name="nip_bps" class="input input-bordered w-full" required value="{{ old('nip_bps', $user->nip_bps) }}">
                            </div>

                            <div class="form-control w-full md:col-span-2">
                                <label class="label"><span class="label-text font-semibold">Status Akun</span></label>
                            ...
                            <div class="divider md:col-span-2">Ubah Password (Opsional)</div>

                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">Password Baru</span></label>
                                <input type="password" name="password" placeholder="Isi jika ingin diubah" class="input input-bordered w-full">
                            </div>

                            <div class="form-control w-full">
                                <label class="label"><span class="label-text font-semibold">Konfirmasi Password Baru</span></label>
                                <input type="password" name="password_confirmation" placeholder="Ketik ulang password baru" class="input input-bordered w-full">
                            </div>
                        </div>
